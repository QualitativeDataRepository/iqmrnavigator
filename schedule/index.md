...
<div class="container-fluid">
        ...
        <table class="schedule-grid">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="session-cell">
                        <div class="session-content special-content">
                            <div class="session-title">Opening Reception</div>
                            <div class="session-location">6pm, Maxwell Foyer and Patio</div>
                        </div>
                    </td>
                    <td class="session-cell">
                ...
                <tr>
                    ...
                    <td class="session-cell">
                        <div class="session-content holiday-content">
                            ...
                            <div class="session-location">Dinner with Advances authors (evening)</div>
                        </div>
                    </td>
                    <td class="session-cell empty-cell"></td>
                    <td class="session-cell empty-cell"></td>
                ...
                <tr>
                    ...
                    <td class="session-cell">
                        <div class="session-content workshop-content">
                            <div class="session-title">Weekend Workshop – Advances in Qualitative and Multi-Method Research</div>
                            <div class="session-instructors">Organizers: Alan Jacobs and Erica Simmons</div>
                            <!-- <div class="session-location">TBD</div> -->
                        </div>
                    </td>
                    <td class="session-cell empty-cell"></td>
    ...
    <!-- Week 2 Schedule -->
    <div class="week-heading">Week 2: June 21-26</div>
    <div class="schedule-container overflow-scroll">
        <table class="schedule-grid">
            <thead>
                <tr>
