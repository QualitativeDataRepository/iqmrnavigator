...
You can find the [IQMR 2026 schedule](/schedule) here. Each module name is linked to an underlying page that contextualizes the module in the module sequence of which it forms part, including a description of all of the included modules; a description of the sessions that form each module; and required and recommended readings for each session. We will add information over time; full information on the entire curriculum will be available in May 2026. Please complete the [module selection form](https://syracuseuniversity.qualtrics.com/jfe/form/SV_eDvMKFdIcjGwMvk){: target="_blank"} by **June 1**.
