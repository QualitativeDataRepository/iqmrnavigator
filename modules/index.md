...
The module discusses four key elements of CHA:
  ...
  - First, CHA identifies the temporal and spatial building blocks used to construct context. It does not treat context as residual noise or spurious co-variations. Instead, CHA draws on history to think of time as sequential events that either replicate or transform the past. It also draws on geography to think of space as interconnected places that either remain exceptional or become more uniform.

  - Second, CHA is problem driven and therefore engages in exploratory topic analysis. Exploration is messy and needs to be translated into description and patterns that help formulate new research questions. CHA employs two description strategies. Eventful analysis employs thick, historical description and identifies patterns of continuity and discontinuity across time as well as convergence and divergence across space. Longue durée analysis employs time series and data visualization to graph longitudinal or cross-spatial trends.

  - Third, CHA emphasizes the importance of theory in building causal arguments. It regularly employs abductive reasoning to update existing explanations or develop new ones. Theories only have a small empirical footprint and background a wide range of causal factors. CHA uses theory to foreground overlooked causal factors, identify confounders, and generate more test-worthy hypotheses.

  - Fourth, CHA uses causal graphs to make testing transparent. CHA is committed to visualizing its arguments in causal graphs. Such graphing improves causal inferences by making transparent causal pathways, locating confounders, constructing strong tests, specifying scope conditions, and identifying types of causality.
...
## [Integrating Qualitative Methods and Natural Experiments](/modules/integrating-qualitative-and-experimental-methods)
...
## [Real-World Research Ethics](/modules/research-ethics)
